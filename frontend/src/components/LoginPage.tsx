    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-50 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md z-10 shadow-xl border-slate-200">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight text-slate-900">Вход в аккаунт</CardTitle>
          <CardDescription className="text-slate-500">
            Войдите, чтобы управлять бронированиями и профилем
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
        <Button 
            className="w-full h-12 text-base font-medium bg-blue-600 hover:bg-blue-700 text-black transition-colors border" 
            onClick={login}
          >
